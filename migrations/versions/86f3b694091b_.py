...
Revision ID: 86f3b694091b
Revises: 
Create Date: 2022-12-09 16:59:15.369852
...
def upgrade():
    ...
    sa.Column('server_img', sa.String(length=255), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('message_content', sa.String(length=255), nullable=False),
